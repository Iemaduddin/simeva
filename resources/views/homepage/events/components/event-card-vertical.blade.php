@forelse ($events as $event)
    ...
    @auth
        @continue(!$showEvent)
    @endauth
    <div class="col-lg-4 col-sm-6 event-card">
        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                <a class="w-100 h-100" href="{{ route('detail_event', $event->id) }}">
                    <img src="{{ asset('storage/' . $event->pamphlet_path) }}" alt="Pamflet Event"
                ...
                @php
                    ...
                    } elseif ($event->scope === 'Internal Jurusan' && $event->organizers->organizer_type === 'HMJ') {
                ...
                <div class="">
                    ...
                    <div class="flex-between gap-8 flex-wrap my-5">
                        <div class="flex-align gap-4">
                            ...
                            <span class="text-neutral-700 text-md fw-medium text-line-1">{{ $locationString }}</span>
                        </div>
                    </div>
                    <div class="flex-between gap-8 flex-wrap my-10">
                        <div class="flex-align gap-4">
                            <span class="text-neutral-700 text-2xl d-flex"><i class="ph-bold ph-user-circle"></i></span>
