        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Perbarui Event</h5>
                </div>
                <div class="card-body form-wizard">
                    <form id="updateEventForm" action="{{ route('update.event', $event->id) }}" class="needs-validation"
                        ...
                        <fieldset class="wizard-fieldset show">
                            ...
                            <div class="row gy-3">
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control" name="title" rows="4" cols="50" val placeholder="Masukkan nama event..."
                                        required>{{ $event->title }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="scope" required>
                                        <option disabled>Pilih Sasaran</option>
                                        <option value="Internal Organisasi"
                                            {{ $event->scope === 'Internal Organisasi' ? 'selected' : '' }}>Internal
                                            Organisasi
                                        </option>
                                        @if (Auth::user()->organizer->organizer_type === 'HMJ' || Auth::user()->organizer->organizer_type === 'Jurusan')
                                            <option value="Internal Jurusan"
                                                {{ $event->scope === 'Internal Jurusan' ? 'selected' : '' }}>Internal
                                                Jurusan</option>
                                        @endif
                                        <option value="Internal Kampus"
                                            {{ $event->scope === 'Internal Kampus' ? 'selected' : '' }}>Internal Kampus
                                        </option>
                                        <option value="Umum" {{ $event->scope === 'Umum' ? 'selected' : '' }}>Umum
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="event_category" required>
                                        ...
                                        <option value="Seminar"
                                            {{ $event->event_category === 'Seminar' ? 'selected' : '' }}>Seminar</option>
                                        <option value="Kuliah Tamu"
                                            {{ $event->event_category === 'Kuliah Tamu' ? 'selected' : '' }}>Kuliah Tamu
                                        </option>
                                        <option value="Pelatihan"
                                            {{ $event->event_category === 'Pelatihan' ? 'selected' : '' }}>Pelatihan
                                        </option>
                                        <option value="Workshop"
                                            {{ $event->event_category === 'Workshop' ? 'selected' : '' }}>Workshop</option>
                                        <option value="Kompetisi"
                                            {{ $event->event_category === 'Kompetisi' ? 'selected' : '' }}>Kompetisi
                                        </option>
                                        <option value="Lainnya"
                                            {{ $event->event_category === 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                @if (Auth::user()->organizer->organizer_type === 'Kampus' || Auth::user()->organizer->organizer_type === 'Jurusan')
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan kuota event..."
                                            name="event_leader" value="{{ $event->event_leader }}" required>
                                        <div class="invalid-feedback">
                                ...
                                @else
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" name="event_leader" required>
                                            <option disabled>Pilih Ketua Pelaksana</option>
                                            @foreach ($team_members as $member)
                                                <option value="{{ $member->id }}"
                                                    {{ $event->event_leader === $member->name ? 'selected' : '' }}>
                                                    {{ $member->name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" placeholder="Masukkan kuota event..."
                                        name="quota" value="{{ $event->quota }}" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="is_free" id="is_free" required>
                                        <option value="0" {{ $event->is_free == '0' ? 'selected' : '' }}>Berbayar
                                        </option>
                                        <option value="1" {{ $event->is_free == '1' ? 'selected' : '' }}>Gratis
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" name="is_publish" id="is_publish" required>
                                        <option value="1" {{ $event->is_publish == '1' ? 'selected' : '' }}>Ya
                                        </option>
                                        <option value="0" {{ $event->is_publish == '0' ? 'selected' : '' }}>Tidak
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="benefit" id="benefit"
                                        value="{{ $event->benefit }}" placeholder="Masukkan benefit event..." />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="contact_person" id="contact_person"
                                        value="{{ $event->contact_person }}" placeholder="Masukkan contact person..." />
                                ...
                                <div id="event-prices-container">
                                    @foreach ($event->prices as $itemPrice)
                                        <div class="event-price">
                                            <input type="hidden" name="price_ids[]" value="{{ $itemPrice->id }}">
                                            <div
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="name_category_prices[]"
                                                        value="{{ $itemPrice->category_name }}" required>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        placeholder="Masukkan harga event" id="price-input"
                                                        name="prices[]" value="{{ $itemPrice->price }}" required>
                                                    <div class="invalid-feedback">
                                                        Harga wajib diisi!
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Cakupan User <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select" id="scope-select" name="scopes[]"
                                                        required>
                                                        <option disabled>Pilih Cakupan User</option>
                                                        @if (Auth::user()->organizer->organizer_type === 'HMJ' || Auth::user()->organizer->organizer_type === 'Jurusan')
                                                            <option value="Internal Jurusan"
                                                                {{ $itemPrice->price === 'Internal Jurusan' ? 'selected' : '' }}>
                                                                Internal Jurusan
                                                                {{ Auth::user()->jurusan->kode_jurusan ?? '' }}</option>
                                                        @endif
                                                        <option value="Internal Kampus"
                                                            {{ $itemPrice->scope === 'Internal Kampus' ? 'selected' : '' }}>
                                                            Internal Kampus
                                                        </option>
                                                        <option value="Eksternal Kampus"
                                                            {{ $itemPrice->scope === 'Eksternal Kampus' ? 'selected' : '' }}>
                                                            Eksternal Kampus
                                                        </option>
                                                        <option value="Umum"
                                                            {{ $itemPrice->scope === 'Umum' ? 'selected' : '' }}>Umum
                                                        </option>
                                                    </select>
                                                    <div class="invalid-feedback">
                        ...
                        <fieldset class="wizard-fieldset">
                            ...
                            <div class="row gy-3" id="registration_fields">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control date-time-registration-pickr"
                                        ...
                                        value="{{ $event->registration_date_start }}">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control date-time-registration-pickr"
                                        ...
                                        value="{{ $event->registration_date_end }}">
                                    <div class="invalid-feedback">
                            ...
                            <div id="event-steps-container">
                                @foreach ($event->steps as $itemStep)
                                    @php
                                        $locationData = json_decode($itemStep->location, true);
                                        $locationType = $locationData[0]['type'] ?? '';
                                        $location = $locationData[0]['location'] ?? '';
                                        $address = $locationData[0]['address'] ?? '';

                                        $locationOnline = $locationData[0]['location_online'] ?? '';
                                        $locationOffline = $locationData[0]['location_offline'] ?? '';
                                        $addressLocationOffline = $locationData[0]['address_location_offline'] ?? '';
                                    @endphp
                                    <div class="event-step">
                                        <input type="hidden" name="step_ids[]" value="{{ $itemStep->id }}">
                                        <div class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
                                            ...
                                            <div class="col-md-6 event_step_description d-none">
                                                ...
                                                <textarea class="form-control" name="event_step_descriptions[]" rows="4" cols="50"
                                                    placeholder="Masukkan deskripsi tahapan event...">{{ $itemStep->description }}</textarea>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Tanggal Pelaksanaan <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control date-execution-pickr"
                                                    name="event_dates[]" value="{{ $itemStep->event_date }}" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" class="form-control time-start-execution-pickr"
                                                    name="event_time_starts[]" value="{{ $itemStep->event_time_start }}"
                                                    required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" class="form-control time-end-execution-pickr"
                                                    ...
                                                    value="{{ $itemStep->event_time_end }}"required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select execution-system" name="execution_systems[]"
                                                    required>
                                                    <option disabled>Pilih Sistem Pelaksanaan</option>
                                                    <option value="offline"
                                                        {{ $itemStep->execution_system === 'offline' ? 'selected' : '' }}>
                                                        Offline</option>
                                                    <option value="online"
                                                        {{ $itemStep->execution_system === 'online' ? 'selected' : '' }}>
                                                        Online</option>
                                                    <option value="hybrid"
                                                        {{ $itemStep->execution_system === 'hybrid' ? 'selected' : '' }}>
                                                        Hybrid</option>
                                                </select>
                                                <div class="invalid-feedback">
                                            ...
                                            @if ($itemStep->execution_system !== 'hybrid')
                                                <div class="col-md-3 location-container">
                                                    ...
                                                    <select class="form-select location-type" name="location_type[]"
                                                        required>
                                                        <option value="campus"
                                                            {{ $itemStep->location_type === 'campus' ? 'selected' : '' }}>
                                                            Gunakan Aset Kampus</option>
                                                        <option value="manual"
                                                            {{ $itemStep->location_type === 'manual' ? 'selected' : '' }}>
                                                            Isi Manual</option>
                                                    </select>
                                                    <select class="form-select mt-3 asset-select" name="locations[]"
                                                        id="campus-asset"
                                                        @if ($itemStep->execution_system === 'online' || $itemStep->location_type === 'manual') style="display: none" disabled @endif>>
                                                        <option value="" disabled>Pilih Aset Kampus...</option>
                                                    ...
                                                    <input type="text" class="form-control mt-3 location-input"
                                                        name="locations[]" placeholder="Masukkan lokasi event..."
                                                        value="{{ $location }}"
                                                        @if ($itemStep->location_type === 'campus') style="display: none" disabled @endif>
                                                    <div class="invalid-feedback">
                                                        Lokasi event wajib diisi!
                                                    </div>
                                                    <input type="text" class="form-control mt-3 address-location-input"
                                                        name="address_locations[]"
                                                        placeholder="Masukkan alamat lokasi event..."
                                                        value="{{ $address }}"
                                                        @if ($itemStep->execution_system !== 'offline' || $itemStep->location_type === 'campus') style="display: none" disabled @endif>
                                                    <div class="invalid-feedback">
                                                        Lokasi event wajib diisi!
                                                    </div>
                                                </div>
                                            @else
                                                <div class="col-md-3 location-container">
                                                    <label class="form-label">Lokasi Offline <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select location-type-offline"
                                                    ...
                                                    <select class="form-select mt-3 asset-select-offline"
                                                        name="locations_offline[]" id="campus-asset"
                                                        @if ($itemStep->execution_system === 'online' || $itemStep->location_type === 'manual') style="display: none" disabled @endif>>
                                                        <option value="" disabled>Pilih Aset Kampus...</option>
                                                        ...
                                                        @if ($buildings->where('facility_scope', 'umum')->isNotEmpty())
                                                            <optgroup label="Fasilitas Umum">
                                                                @foreach ($buildings->where('facility_scope', 'umum')->sortBy('name') as $asset)
                                                                    <option value="{{ $asset->id }}"
                                                                        {{ $locationOffline === $asset->id ? 'selected' : '' }}>
                                                                        {{ $asset->name }}
                                                                    </option>
                                                                @endforeach
                                                            </optgroup>
                                                    ...
                                                    <input type="text" class="form-control mt-3 location-input-offline"
                                                        name="locations_offline[]"
                                                        placeholder="Masukkan lokasi offline..."
                                                        value="{{ $locationOffline }}"
                                                        @if ($itemStep->location_type === 'campus') style="display: none" disabled @endif>
                                                    <div class="invalid-feedback">
                                                        Lokasi event wajib diisi!
                                                    </div>
                                                    <input type="text"
                                                        class="form-control mt-3 address-location-input-offline"
                                                        name="address_locations_offline[]"
                                                        placeholder="Masukkan alamat lokasi offline event..."
                                                        value="{{ $addressLocationOffline }}"
                                                        @if ($itemStep->execution_system !== 'offline' || $itemStep->location_type === 'campus') style="display: none" disabled @endif>
                                                    <div class="invalid-feedback">
                                                        Lokasi event wajib diisi!
                                                    </div>
                                                    <label class="form-label mt-2">Lokasi Online <span
                                                            class="text-danger">*</span></label></label>
                                                    <input type="text" class="form-control location-input-online"
                                                        value="{{ $locationOnline }}" name="locations_online[]"
                                                        placeholder="Masukkan lokasi online..." required>
                                                    <div class="invalid-feedback">
                                                        Lokasi online wajib diisi!
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="text-start mt-3">
                        ...
                        <fieldset class="wizard-fieldset">
                            ...
                            <div id="event-speakers-container">
                                @foreach ($event->steps as $step)
                                    @foreach ($step->event_speaker as $itemSpeaker)
                                        <div class="event-speaker">
                                            <input type="hidden" name="speaker_ids[]" value="{{ $itemSpeaker->id }}">
                                            <div
                                                class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
                                                <div class="col-md-3">
                                                    <label class="form-label">Tanggal & Jam Pelaksanaan <span
                                                            class="text-danger">*</span></label>
                                                    <select class="form-select event-date-select"
                                                        name="event_date_speakers[]">
                                                        <option value="" disabled>Pilih Tanggal</option>
                                                        @foreach ($event->steps as $steps)
                                                            <option value="{{ $steps->event_date }}"
                                                                {{ $step->event_date === $steps->event_date ? 'selected' : '' }}>
                                                                {{ \Carbon\Carbon::parse($steps->event_date)->translatedFormat('d F Y') }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control" name="speaker_name[]"
                                                        placeholder="Masukkan Nama..." value="{{ $itemSpeaker->name }}">
                                                    <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select role" name="role[]">
                                                            <option value="Keynote Speaker"
                                                                {{ $itemSpeaker->role === 'Keynote Speaker' ? 'selected' : '' }}>
                                                                Keynote Speaker</option>
                                                            <option value="Pemateri"
                                                                {{ $itemSpeaker->role === 'Pemateri' ? 'selected' : '' }}>
                                                                Pemateri / Narasumber</option>
                                                            <option value="Moderator"
                                                                {{ $itemSpeaker->role === 'Moderator' ? 'selected' : '' }}>
                                                                Moderator</option>
                                                            <option value="Panelist"
                                                                {{ $itemSpeaker->role === 'Panelist' ? 'selected' : '' }}>
                                                                Panelist</option>
                                                            <option value="MC"
                                                                {{ $itemSpeaker->role === 'MC' ? 'selected' : '' }}>MC
                                                                (Master
                                                                of Ceremony)
                                                            </option>
                                                            <option value="other"
                                                                {{ $itemSpeaker->role === 'other' ? 'selected' : '' }}>
                                                                Lainnya
                                                            </option>
                                                        </select>
                                                        @if (!in_array($itemSpeaker->role, ['Keynote Speaker', 'Pemateri', 'Moderator', 'Panelist', 'MC']))
                                                            <input type="text" class="form-control mt-3 other_role"
                                                                value="{{ $itemSpeaker->role }}" name="other_role[]"
                                                                placeholder="Masukkan peran lainnya">
                                                        @else
                                                            <input type="text"
                                                                class="form-control mt-3 other_role d-none"
                                                                name="other_role[]" placeholder="Masukkan peran lainnya"
                                                                disabled>
                                                        @endif
                                                ...
                                                <div class="text-start mt-3">
                                                    <a href="#"
                                                        class="btn btn-sm btn-danger-600 remove-event-speaker"
                                                        style="display: none;">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <fieldset class="wizard-fieldset">
                            ...
                            <div id="asset-loans-container">
                                <h6 class="text-md text-neutral-500" style="margin-top: 30px">Peminjaman/Izin Dekorasi
                                    <span class="text-sm">(Abaikan jika tidak ada tambahan)</span>
                                </h6>
                                    ...
                                    <div class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select asset-selected" name="loan_assets[]">
                                                <option disabled>Pilih Aset Kampus</option>
                                                {{-- Optgroup Gedung --}}
                                                {{-- akan diisi otomatis --}}
...
@push('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleRequiredFields() {
                ...
                const fields = [benefit, cp, registrationStart, registrationEnd];
                const labels = [benefitLabel, cpLabel, registrationStartLabel,
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addEventPriceButton.addEventListener('click', function(e) {
                ...
                <div class="event-price">
                    <input type="hidden" name="price_ids[]" value="">
                    <div class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
                        <div class="col-md-4">
                            <label class="form-label">Nama Kategori Harga <span
                                    class="text-danger">*</span></label>
    ...
    <script>
            ...
            function eventDateTimePickrChange() {
                ...
                flatpickr(".date-execution-pickr", {
                    ...
                    onChange(selectedDates, dateStr, instance) {
                        ...
                        // Ambil ulang semua date yang ada di .date-execution-pickr
                        const allDates = [];
                        document.querySelectorAll('.date-execution-pickr').forEach(input => {
                            if (input.value && !allDates.includes(input.value)) {
                                allDates.push(input.value);
                            }
                        });

                        // Kirim ke updateEventDateDropdown
                        updateEventDateDropdown(allDates);
                    },
                });
        ...
        `;
            ...
            addEventStepButton.addEventListener('click', function(e) {
                ...
                newStep.classList.add('event-step',
                    'mb-3', 'rounded');
                newStep.innerHTML = `
                <input type="hidden" name="step_ids[]" value="">
            <div class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
        ...
        `;
            ...
            function updateEventDateDropdown(dates) {
                document.querySelectorAll('.event-date-select').forEach(select => {
                    const selectedValue = select.value;

                    select.innerHTML = '<option value="" disabled>Pilih Tanggal</option>';
            ...
            addEventSpeakerButton.addEventListener('click', function(e) {
                ...
                <input type="hidden" name="speaker_ids[]" value="">
                <div class="row gy-3 mt-3 border-3 border-dashed border-primary p-3 mb-3 rounded">
                <div class="col-md-3">
                ...
                // Panggil updateEventDateDropdown dengan parameter
                updateEventDateDropdown(allDates);
            });
            ...
            eventStepsContainer.querySelectorAll('.event-step').forEach(eventStep => {
                handleExecutionSystemChange(eventStep);
            });
