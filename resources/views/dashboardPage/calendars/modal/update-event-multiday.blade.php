<div class="modal fade" id="editCalendarEventMultiDay" tabindex="-1" aria-labelledby="editCalendarEventMultiDayLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
        <div class="modal-content radius-16 bg-base">
            <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                <h1 class="modal-title fs-5" id="editCalendarEventMultiDayLabel">Edit Event</h1>
