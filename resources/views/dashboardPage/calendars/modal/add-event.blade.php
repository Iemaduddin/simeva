<div class="modal fade" id="addCalendarEvent" tabindex="-1" aria-labelledby="addCalendarEventLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
        <div class="modal-content radius-16 bg-base">
            <div class="modal-header py-16 px-24 border border-top-0 border-start-0 border-end-0">
                <h1 class="modal-title fs-5" id="addCalendarEventLabel">Tambah Event Baru</h1>
                        ...
                        <div class="col-md-12 mb-10">
                            <div class="form-check style-check d-flex align-items-center mb-2">
                                <input class="form-check-input radius-4 border border-neutral-400 me-2 all_day"
                                    id="all_day" type="checkbox" name="all_day"
