            ...
            <div class="modal-body p-24">
                ...
                <form id="{{ $tableId }}" action="{{ route('assetBooking.confirmPayment', $assetBooking->id) }}"
                    ...
                    <div class="row mt-3 loading-date">
                        ...
                        <div class="col-md-4">
                            <label for="loading_date_start">Tanggal dan Waktu Mulai Loading</label>
                        ...
                        <div class="col-md-4">
                            <label for="loading_date_end">Tanggal dan Waktu Selesai Loading</label>
                        ...
                        <div class="col-md-4">
                            <label for="unloading_date">Tanggal dan Waktu Unloading</label>
...
<script>
    ...
    document.addEventListener("change", function(event) {
        if (event.target.classList.contains("actionConfirmPayment")) {
            ...
            if (!loadingDate || !reason || !reasonField || !loadingDateStart || !loadingDateEnd || !
